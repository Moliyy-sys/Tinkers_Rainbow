...
public class ModBlocks {
    ...
    public static final RegistryObject<LiquidBlock> molten_black_opal_block = BLOCKS.register("molten_black_opal_block",
            ()->new BurningLiquidBlock(ModFluid.source_molten_black_opal,CommonLiquid,10,2f));
