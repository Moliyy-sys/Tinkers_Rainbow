...
public class ModFluid {
    ...
    public static final RegistryObject<FlowingFluid> source_molten_black_opal = FLUIDS.register("molten_black_opal",
            () -> new ForgeFlowingFluid.Source(ModFluid.molten_black_opal));
    public static final RegistryObject<FlowingFluid> flowing_molten_black_opal = FLUIDS.register("flowing_molten_black_opal",
            () -> new ForgeFlowingFluid.Flowing(ModFluid.molten_black_opal));
    public static final ForgeFlowingFluid.Properties molten_black_opal = new ForgeFlowingFluid.Properties(
            ModFluidTypes.molten_black_opal, source_molten_black_opal, flowing_molten_black_opal).slopeFindDistance(2).levelDecreasePerBlock(2)
            .block(ModBlocks.molten_black_opal_block).bucket(ModItems.molten_black_opal_bucket);
